...
export const educationItems: TimelineItem[] = [
  {
    ...
    roleEn: "Professional Bachelor's Degree – Software Architecture & Web Integration (DA2I)",
    location: "Lille",
    startDate: "2022",
    endDate: "2023",
    current: false,
    shortDescription: "Approfondissement de l'architecture logicielle, Java et Spring. Méthodes agiles et projet tuteuré.",
    shortDescriptionEn: "Deep dive into software architecture, Java and Spring Framework. Agile methodologies applied in a supervised company project.",
    missions: [
  ...
  },
  {
    ...
    roleEn: "Higher National Diploma – IT Solutions & Business Applications (SLAM)",
    location: "Roubaix",
    startDate: "2020",
    endDate: "2022",
    current: false,
    shortDescription: "Développement d'applications (Java, Python, PHP, Symfony) et gestion de bases de données SQL.",
    shortDescriptionEn: "Application development (Java, Python, PHP, Symfony) and SQL database design and management.",
    missions: [
  ...
  },
  {
    ...
    roleEn: "Scientific Baccalaureate – Engineering Sciences with Digital Technology Specialization (ISN)",
    location: "Roubaix",
    startDate: "2017",
    endDate: "2020",
    current: false,
    shortDescription: "Formation de la pensée logique, mathématique et initiation aux sciences du numérique.",
    shortDescriptionEn: "Development of logical and mathematical thinking with an introduction to computer science and digital technology.",
    missions: [
