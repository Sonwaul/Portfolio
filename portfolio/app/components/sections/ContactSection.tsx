    ...
    <section id="contact" className="contact-section">
      ...
      <div className="container contact-content">
        ...
        <div className="contact-inner">
          ...
          <div className="contact-card">
            <p className="contact-socials-title">{messages.contact.socialsTitle}</p>
            <div className="contact-socials">
              ...
              <button className="contact-social-link contact-cv-btn" onClick={() => setCvOpen(true)}>
                <svg className="contact-social-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
                ...
                <span>{messages.contact.cvLabel}</span>
              </button>
            </div>
          </div>
        </div>
